...
s.source       = { :git => "" }
s.source_files  ="node_modules/react-native-image-crop-picker/ios/*.{h,m}", "node_modules/react-native-image-crop-picker/ios/UIImage-Resize/*.{h,m}", "node_modules/react-native-image-crop-picker/ios/RSKImageCropper/*.{h,m}", "node_modules/react-native-image-crop-picker/ios/QBImagePicker/*.{h,m}"
